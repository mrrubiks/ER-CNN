...
class Net(nn.Module):
    ...
    def generate_cnn(self, model_name, num_classes, pretrained=True):
    ...
    def __init__(self, key_size, num_classes, model_name, adaptation, adaptation_pretrained=False):
        ...
        self.model = self.generate_cnn(self.model_name, num_classes, pretrained=True)
